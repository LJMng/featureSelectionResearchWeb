...
var vm=new Vue({
    ...
    data: {
        pageElements: [{"htmlName":"htmlElementList","moduleKey":"aad","chValue":"dd","enValue":"hi","type":"text"},{"htmlName":"sda","moduleKey":"aad","chValue":"哈哈","enValue":"hi","type":"text"},{"htmlName":"execution","moduleKey":"home","chValue":"一","enValue":"one","type":"string"},{"htmlName":"htmlElementList","moduleKey":"home_text","chValue":"哈哈","enValue":"laught","type":"uri"}],
        Values: "",
        moduleKey:'',
        checkModuleKey:'',
        checkHtmlName:'',
