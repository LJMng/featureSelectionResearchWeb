...
public class DatasetForm {
  ...
  private java.sql.Timestamp inputReviewTime;
  private java.sql.Timestamp inputEndTime;
  ...
  public long getInputRecord() {
    return inputRecord;
  }

  public void setInputRecord(long inputRecord) {
  ...
  public java.sql.Timestamp getInputReviewTime() {
    return inputReviewTime;
  }

  public void setInputReviewTime(java.sql.Timestamp inputReviewTime) {
    this.inputReviewTime = inputReviewTime;
  }


  public java.sql.Timestamp getInputEndTime() {
    return inputEndTime;
  }

  public void setInputEndTime(java.sql.Timestamp inputEndTime) {
